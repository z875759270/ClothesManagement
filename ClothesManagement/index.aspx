...
<body id="skin-blur-lights">
    ...
    <header id="header" class="media">
        <a href="index.aspx" id="menu-toggle"></a>
        <a class="logo pull-left" href="index.aspx">服装仓库管理系统</a>

        <div class="media-body">
            <div class="media" id="top-menu">
                <div class="pull-left tm-icon">
                    <a data-drawer="messages" class="drawer-toggle" href="index.aspx">
                ...
                <div class="pull-left tm-icon">
                    <a data-drawer="notifications" class="drawer-toggle" href="index.aspx">
        ...
        <aside id="sidebar">
            ...
            <div class="side-widgets overflow">
                ...
                <div class="text-center s-widget m-b-25 dropdown" id="profile-menu">
                    <a href="index.aspx" data-toggle="dropdown">
                        <img class="profile-pic animated" src="img/profile-pic.jpg" alt="" />
                    </a>
                    <ul class="dropdown-menu profile-menu">
                        <li><a href="index.aspx">My Profile</a> <i class="icon left">&#61903;</i><i class="icon right">&#61815;</i></li>
                        <li><a href="index.aspx">Messages</a> <i class="icon left">&#61903;</i><i class="icon right">&#61815;</i></li>
                ...
                <!-- Projects -->
                <div class="s-widget m-b-25">
                    <h2 class="tile-title">Projects on going
                        </h2>
                    ...
                    <div class="s-widget-body">
                        <div class="side-border">
                            ...
                            <div class="progress progress-small">
                                <a href="index.aspx#" data-toggle="tooltip" title="" class="progress-bar tooltips progress-bar-danger" style="width: 60%;" data-original-title="60%">
                        ...
                        <div class="side-border">
                            ...
                            <div class="progress progress-small">
                                <a href="index.aspx#" data-toggle="tooltip" title="" class="tooltips progress-bar progress-bar-info" style="width: 43%;" data-original-title="43%">
                        ...
                        <div class="side-border">
                            ...
                            <div class="progress progress-small">
                                <a href="index.aspx#" data-toggle="tooltip" title="" class="tooltips progress-bar progress-bar-warning" style="width: 81%;" data-original-title="81%">
                        ...
                        <div class="side-border">
                            ...
                            <div class="progress progress-small">
                                <a href="index.aspx#" data-toggle="tooltip" title="" class="tooltips progress-bar progress-bar-success" style="width: 10%;" data-original-title="10%">
                        ...
                        <div class="side-border">
                            ...
                            <div class="progress progress-small">
                                <a href="index.aspx#" data-toggle="tooltip" title="" class="tooltips progress-bar progress-bar-success" style="width: 95%;" data-original-title="95%">
            ...
            <ul class="list-unstyled side-menu">
                <li class="active">
                    <a class="sa-side-home" href="index.aspx">
                ...
                <li class="dropdown">
                    <a class="sa-side-form" href="index.aspx">
                ...
                <li class="dropdown">
                    <a class="sa-side-ui" href="index.aspx">
                ...
                <li class="dropdown">
                    <a class="sa-side-page" href="index.aspx">
        ...
        <section id="content" class="container">
            ...
            <div id="messages" class="tile drawer animated">
                <div class="listview narrow">
                    <div class="media">
                        <a href="index.aspx">Send a New Message</a>
                    ...
                    <div class="overflow" style="height: 254px">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <a class="t-overflow" href="index.aspx">Mauris consectetur urna nec tempor adipiscing. Proin sit amet nisi ligula. Sed eu adipiscing lectus</a>
                            </div>
                        </div>
                        <div class="media">
                            <div class="pull-left">
                            ...
                            <div class="media-body">
                                ...
                                <a class="t-overflow" href="index.aspx">Suspendisse in purus ut nibh placerat Cras pulvinar euismod nunc quis gravida. Suspendisse pharetra</a>
                            </div>
                        </div>
                        <div class="media">
                            <div class="pull-left">
                            ...
                            <div class="media-body">
                                ...
                                <a class="t-overflow" href="index.aspx">Maecenas venenatis enim condimentum ultrices fringilla. Nulla eget libero rhoncus, bibendum diam eleifend, vulputate mi. Fusce non nibh pulvinar, ornare turpis id</a>
                            </div>
                        </div>
                        <div class="media">
                            <div class="pull-left">
                            ...
                            <div class="media-body">
                                ...
                                <a class="t-overflow" href="index.aspx">Phasellus interdum felis enim, eu bibendum ipsum tristique vitae. Phasellus feugiat massa orci, sed viverra felis aliquet quis. Curabitur vel blandit odio. Vestibulum sagittis quis sem sit amet tristique.</a>
                            </div>
                        </div>
                        <div class="media">
                            <div class="pull-left">
                            ...
                            <div class="media-body">
                                ...
                                <a class="t-overflow" href="index.aspx">Ipsum wintoo consectetur urna nec tempor adipiscing. Proin sit amet nisi ligula. Sed eu adipiscing lectus</a>
                            </div>
                        </div>
                        <div class="media">
                            <div class="pull-left">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <a class="t-overflow" href="index.aspx">Integer a eros dapibus, vehicula quam accumsan, tincidunt purus</a>
                            </div>
                        </div>
                    </div>
                    <div class="media text-center whiter l-100">
                        <a href="index.aspx"><small>VIEW ALL</small></a>
                    </div>
                </div>
            </div>
            ...
            <div id="notifications" class="tile drawer animated">
                <div class="listview narrow">
                    <div class="media">
                        <a href="index.aspx">Notification Settings</a>
                        <span class="drawer-close">&times;</span>
                    </div>
                    <div class="overflow" style="height: 254px">
                        <div class="media">
            ...
            <ol class="breadcrumb hidden-xs">
                ...
                <li><a href="index.aspx#">Library</a></li>
            ...
            <div class="block-area shortcut-area">
                <a class="shortcut tile" href="index.aspx">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="tile">
                            ...
                            <div class="tile-config dropdown">
                                <a data-toggle="dropdown" href="index.aspx" class="tile-menu"></a>
                                <ul class="dropdown-menu pull-right text-right">
                                    <li><a class="tile-info-toggle" href="index.aspx">Chart Information</a></li>
                                    <li><a href="index.aspx">Refresh</a></li>
                                    <li><a href="index.aspx">Settings</a></li>
                                </ul>
                            </div>
                            <div class="p-10">
                                ...
                                <div class="chart-info">
                                    <ul class="list-unstyled">
                                        <li class="m-b-10">Total Sales 1200
                                    ...
                                    <div class="listview narrow">
                                        <div class="media p-l-5">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <a class="t-overflow" href="index.aspx">Cras molestie fermentum nibh, ac semper</a>
                                        ...
                                        <div class="media p-l-5">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <a class="t-overflow" href="index.aspx">Suspendisse in purus ut nibh placerat</a>
                                        ...
                                        <div class="media p-l-5">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <a class="t-overflow" href="index.aspx">Cras pulvinar euismod nunc quis gravida. Suspendisse pharetra</a>
                                        ...
                                        <div class="media p-l-5">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <a class="t-overflow" href="index.aspx">Cras pulvinar euismod nunc quis gravida. </a>
                            ...
                            <div class="col-md-6">
                                <div class="tile">
                                    ...
                                    <div class="tile-config dropdown">
                                        <a data-toggle="dropdown" href="index.aspx" class="tile-menu"></a>
                                        <ul class="dropdown-menu pull-right text-right">
                                            <li id="todo-add"><a href="index.aspx">Add New</a></li>
                                            <li id="todo-refresh"><a href="index.aspx">Refresh</a></li>
                                            <li id="todo-clear"><a href="index.aspx">Clear All</a></li>
                                        </ul>
                                    </div>
            ...
            <div class="chat">
                ...
                <div class="media-body">
                    <div class="chat-header">
                        <a class="btn btn-sm" href="index.aspx">
